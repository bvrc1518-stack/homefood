...
export default function CheckoutPage() {
  ...
  const stripeOptions = {
    ...
    amount: Math.round((subtotal / 100) * currency.rate * 100),
      ...
      <div className="grid lg:grid-cols-5 gap-10">
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-2xl p-6 border border-warm-100 shadow-sm">
            {/* Shipping regions */}
            <div className="flex gap-3 mb-6 p-3 bg-warm-50 rounded-xl">
              <p className="text-xs text-warm-500">Ships to:</p>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-2xl p-6 border border-warm-100 shadow-sm sticky top-24">
            ...
            <div className="border-t border-warm-100 pt-4 space-y-2 text-sm">
              ...
              <div className="flex justify-between text-warm-500">
                <span>Shipping</span>
                <span className="text-warm-800">Calculated after address</span>
              </div>
            ...
            <div className="mt-4 p-3 bg-green-50 rounded-xl border border-green-100">
              <p className="text-xs text-green-700 text-center">
                💳 We accept Visa, Mastercard, Amex, UPI & more
              </p>
            </div>
          </div>
        </div>
